...
<div class="container ">
    <h1 class="mb-2 text-center title3 mt51">Nossos Clientes</h1>
    <p class="text-center mb52 tex mt-0 pb-4">Confira nossa lista de clientes atendidos</p>
...
<div class="container">
    ...
    <div class="card hovered text-center align-items-center">
        <img src="img/IMG_0320.png" class="img-fluid cliente" alt="">
        <h3>D'Última Hora Pesca</h3>
        <p class="mt-2">Serviço: Site Empresarial</p>
        <button class="btn btn-primary mt-3 w-100" 
        onclick="window.open('https://dultimahorapesca.com.br/', '_blank');">
    VISITAR WEBSITE <i class="fa-solid fa-square-up-right mx-2"></i>
</button>
    </div>
    </div>
    ...
    <div class="col-md-3 text-center">
    <div class="card hovered text-center align-items-center">
        <img src="img/alfa.png" class="img-fluid cliente" alt="">
        <h3>Swat Alfa - Habbo Hotel</h3>
        <p class="mt-2">Serviço: Site e Painel Administrativo</p>
        <button class="btn btn-primary mt-3 w-100" 
